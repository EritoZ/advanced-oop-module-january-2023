...
class F1SeasonApp:
    ...
    def new_race_results(self, race_name: str, red_bull_pos: int, mercedes_pos: int):
        ...
        if self.red_bull_team and self.mercedes_team:
            ...
            better_team = min((('Red Bull', red_bull_pos), ('Mercedes', mercedes_pos)), key=lambda t: t[1])

            return f"Red Bull: { red_bull_message }. Mercedes: { mercedes_message }. " \
                   f"{ better_team[0] } is ahead at the { race_name } race."
